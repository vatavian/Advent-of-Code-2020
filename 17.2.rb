# Advent of Code 2020 Day 17 part 2, Conway Cubes in a 4-dimensional pocket universe
...
class Universe
  ...
  def initialize(initial_state)
    ...
    initial_state.each_with_index do |row, y|
      row.each_char.with_index {|char, x| @all_cubes[[x,y,z,w]] = true if char == '#'}
    end
    @neighbor_directions = [-1, 0, 1].repeated_permutation(4).to_a
    @neighbor_directions.delete([0,0,0,0])
  ...
  def step
    ...
    @all_cubes.each do |key, value|
      ...
      @neighbor_directions.each do |dir|
        neighbor_key = [x+dir[0],y+dir[1],z+dir[2],w+dir[3]]
